  var fMc = __commonJS((Pgv, MDf) => {
    MDf.exports = `#!/usr/bin/env node
...
`;
  ...
  var hMc = __commonJS((Ogv, NDf) => {
    NDf.exports = `// Shared by probe.mjs, compare.mjs, and package-capture.mjs. Kept standalone
