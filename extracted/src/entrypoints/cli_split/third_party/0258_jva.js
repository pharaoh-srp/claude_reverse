  ...
  var Vva = __commonJS((lXy, Gva) => {
    function uRp(e) {
      ...
      return {
        ...
        contains: [e.HASH_COMMENT_MODE, t, n, r, o, s, i]
      };
    }
    Gva.exports = uRp;
  });
  var Kva = __commonJS((cXy, zva) => {
    function dRp(e) {
      let t = e.regex;
      let n = {
        begin: /<\/?[A-Za-z_]/,
  ...
  var Jva = __commonJS((uXy, Yva) => {
    ...
    function mRp(e) {
      ...
      let d = {
        className: "number",
        relevance: 0,
        begin: t.concat(s, t.optional(l), t.optional(c))
      };
      ...
      return {
        ...
        contains: [e.COMMENT(/\(\*/, /\*\)/, {
          contains: ["self"]
        }), y, _, S, f, h, e.QUOTE_STRING_MODE, d, g, b]
      };
    }
    Yva.exports = mRp;
  });
  var Qva = __commonJS((dXy, Xva) => {
    function fRp(e) {
      let n = {
        relevance: 0,
        contains: [{
  ...
  var owa = __commonJS((fXy, rwa) => {
    function yRp(e) {
      ...
      let o = e.inherit(e.APOS_STRING_MODE, {
        relevance: 0
      });
      let s = e.inherit(e.QUOTE_STRING_MODE, {
        relevance: 0
      });
      let i = {
        className: "subst",
  ...
  var fwa = __commonJS((bXy, mwa) => {
    function ERp(e) {
      ...
      let o = [e.inherit(e.C_NUMBER_MODE, {
        starts: {
          end: "(\\s*/)?",
          relevance: 0
        }
      ...
      return {
        ...
        keywords: t,
        illegal: /\/\*/,
        contains: o.concat([e.COMMENT("--", "$"), {
          className: "function",
          begin: "^\\s*[A-Za-z$_][0-9A-Za-z$_]*\\s*=\\s*" + i,
          end: "[-=]>",
          returnBegin: true,
          contains: [s, a]
        }, {
  ...
  var wwa = __commonJS((wXy, vwa) => {
    function xRp(e) {
      ...
      let b = {
        scope: "params",
        match: new RegExp("[A-Za-z_][A-Za-z0-9_'-]*\\s*:(?=\\s)")
      };
      let S = [u, e.HASH_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, e.COMMENT(/\/\*\*(?!\/)/, /\*\//, {
  ...
  var kwa = __commonJS((RXy, xwa) => {
    function ARp(e) {
      let t = e.regex;
      let n = ["ADMINTOOLS", "APPDATA", "CDBURN_AREA", "CMDLINE", "COMMONFILES32", "COMMONFILES64", "COMMONFILES", "COOKIES", "DESKTOP", "DOCUMENTS", "EXEDIR", "EXEFILE", "EXEPATH", "FAVORITES", "FONTS", "HISTORY", "HWNDPARENT", "INSTDIR", "INTERNET_CACHE", "LANGUAGE", "LOCALAPPDATA", "MUSIC", "NETHOOD", "OUTDIR", "PICTURES", "PLUGINSDIR", "PRINTHOOD", "PROFILE", "PROGRAMFILES32", "PROGRAMFILES64", "PROGRAMFILES", "QUICKLAUNCH", "RECENT", "RESOURCES_LOCALIZED", "RESOURCES", "SENDTO", "SMPROGRAMS", "SMSTARTUP", "STARTMENU", "SYSDIR", "TEMP", "TEMPLATES", "VIDEOS", "WINDIR"];
      let r = ["ARCHIVE", "FILE_ATTRIBUTE_ARCHIVE", "FILE_ATTRIBUTE_NORMAL", "FILE_ATTRIBUTE_OFFLINE", "FILE_ATTRIBUTE_READONLY", "FILE_ATTRIBUTE_SYSTEM", "FILE_ATTRIBUTE_TEMPORARY", "HKCR", "HKCU", "HKDD", "HKEY_CLASSES_ROOT", "HKEY_CURRENT_CONFIG", "HKEY_CURRENT_USER", "HKEY_DYN_DATA", "HKEY_LOCAL_MACHINE", "HKEY_PERFORMANCE_DATA", "HKEY_USERS", "HKLM", "HKPD", "HKU", "IDABORT", "IDCANCEL", "IDIGNORE", "IDNO", "IDOK", "IDRETRY", "IDYES", "MB_ABORTRETRYIGNORE", "MB_DEFBUTTON1", "MB_DEFBUTTON2", "MB_DEFBUTTON3", "MB_DEFBUTTON4", "MB_ICONEXCLAMATION", "MB_ICONINFORMATION", "MB_ICONQUESTION", "MB_ICONSTOP", "MB_OK", "MB_OKCANCEL", "MB_RETRYCANCEL", "MB_RIGHT", "MB_RTLREADING", "MB_SETFOREGROUND", "MB_TOPMOST", "MB_USERICON", "MB_YESNO", "NORMAL", "OFFLINE", "READONLY", "SHCTX", "SHELL_CONTEXT", "SYSTEM|TEMPORARY"];
      let o = ["addincludedir", "addplugindir", "appendfile", "assert", "cd", "define", "delfile", "echo", "else", "endif", "error", "execute", "finalize", "getdllversion", "gettlbversion", "if", "ifdef", "ifmacrodef", "ifmacrondef", "ifndef", "include", "insertmacro", "macro", "macroend", "makensis", "packhdr", "searchparse", "searchreplace", "system", "tempfile", "undef", "uninstfinalize", "verbose", "warning"];
      let s = {
      ...
      return {
        ...
        }, m, u, i, a, l, c, p, e.NUMBER_MODE]
      };
    }
    xwa.exports = ARp;
  });
  var Iwa = __commonJS((xXy, Awa) => {
    function IRp(e) {
      let t = {
        className: "built_in",
  ...
  var Mwa = __commonJS((AXy, Dwa) => {
    function ORp(e) {
      ...
      let o = e.inherit(e.QUOTE_STRING_MODE, {
        illegal: null
      });