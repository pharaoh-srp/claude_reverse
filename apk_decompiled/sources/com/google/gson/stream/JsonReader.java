...
public class JsonReader implements Closeable {
    ...
    static {
        di9.INSTANCE = new di9() { // from class: com.google.gson.stream.JsonReader.1
            ...
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                ...
                if (iDoPeek == 12) {
                    ...
                    e0.h(sb, jsonReader.locationString());
                }
            }
        };
    }
    ...
    */
    ...
    public String locationString() {
        StringBuilder sbV = vb7.v(" at line ", " column ", this.lineNumber + 1, (this.pos - this.lineStart) + 1, " path ");
        sbV.append(getPath());
        return sbV.toString();
    }
    ...
    public int nextInt() {
        ...
        int i5 = (int) d;
        if (i5 != d) {
            b2.e(this.peekedString, locationString(), "Expected an int but was ");
            return 0;
        }
        this.peekedString = null;
        this.peeked = 0;
    ...
    public long nextLong() throws IOException {
        ...
        long j2 = (long) d;
        if (j2 != d) {
            b2.e(this.peekedString, locationString(), "Expected a long but was ");
            return 0L;
        }
        this.peekedString = null;
        this.peeked = 0;
