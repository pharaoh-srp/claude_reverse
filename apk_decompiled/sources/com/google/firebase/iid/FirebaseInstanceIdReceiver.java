...
public final class FirebaseInstanceIdReceiver extends BroadcastReceiver {
    ...
    public static int a(Intent intent) {
        ...
        if (!zni.Z(intentPutExtras)) {
            return -1;
        }
        zni.N("_nd", intentPutExtras.getExtras());
        return -1;
    }
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        synchronized (FirebaseInstanceIdReceiver.class) {
            try {
                ...
                if (executorServiceUnconfigurableExecutorService == null) {
                    executorServiceUnconfigurableExecutorService = Executors.unconfigurableExecutorService(Executors.newCachedThreadPool(new vk5("firebase-iid-executor", 1)));
        ...
        executorService.execute(new ujk(this, intent, context, zIsOrderedBroadcast, pendingResultGoAsync));
    }
}
