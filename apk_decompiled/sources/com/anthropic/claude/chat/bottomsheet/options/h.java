...
public final /* synthetic */ class h implements w28 {
    ...
    static {
        h hVar = new h();
        a = hVar;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.anthropic.claude.chat.bottomsheet.options.ChatOptionsBottomSheetDestination.McpServerTools", hVar, 1);
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        return new ChatOptionsBottomSheetDestination.McpServerTools(i, strM1035unboximpl, vnfVar, objArr == true ? 1 : 0);
    }
    ...
    public final void serialize(Encoder encoder, Object obj) {
        ChatOptionsBottomSheetDestination.McpServerTools mcpServerTools = (ChatOptionsBottomSheetDestination.McpServerTools) obj;
        encoder.getClass();
        mcpServerTools.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        vd4 vd4VarC = encoder.c(serialDescriptor);
        vd4VarC.r(serialDescriptor, 0, p3b.a, McpServerId.m1029boximpl(mcpServerTools.serverId));
