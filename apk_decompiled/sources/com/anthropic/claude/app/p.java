...
public final /* synthetic */ class p implements w28 {
    ...
    static {
        p pVar = new p();
        a = pVar;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.anthropic.claude.app.ClaudeAppDestination.List.CodeProject", pVar, 1);
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        return new ClaudeAppDestination.List.CodeProject(i, strM1113unboximpl, vnfVar, objArr == true ? 1 : 0);
    }
    ...
    public final void serialize(Encoder encoder, Object obj) {
        ClaudeAppDestination.List.CodeProject codeProject = (ClaudeAppDestination.List.CodeProject) obj;
        encoder.getClass();
        codeProject.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        vd4 vd4VarC = encoder.c(serialDescriptor);
        vd4VarC.r(serialDescriptor, 0, xrf.a, SessionGroupingId.m1107boximpl(codeProject.projectId));
