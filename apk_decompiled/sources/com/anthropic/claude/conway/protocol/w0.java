...
public final /* synthetic */ class w0 implements w28 {
    ...
    static {
        w0 w0Var = new w0();
        a = w0Var;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.anthropic.claude.conway.protocol.StreamMessage.Connected", w0Var, 5);
        ...
        pluginGeneratedSerialDescriptor.j("resume_token", true);
    ...
    public final KSerializer[] childSerializers() {
        ...
        xka xkaVar = xka.a;
        return new KSerializer[]{xkaVar, xkaVar, kSerializerS, srgVar, kSerializerS2};
    }
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        return new StreamMessage.Connected(i, j, j2, str, strV, str2, (vnf) null);
    }
    ...
    public final void serialize(Encoder encoder, Object obj) {
        StreamMessage.Connected connected = (StreamMessage.Connected) obj;
        encoder.getClass();
        connected.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        vd4 vd4VarC = encoder.c(serialDescriptor);
        StreamMessage.Connected.write$Self$conway(connected, vd4VarC, serialDescriptor);
