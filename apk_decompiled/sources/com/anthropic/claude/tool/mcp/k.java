...
public final /* synthetic */ class k implements w28 {
    ...
    static {
        k kVar = new k();
        a = kVar;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.anthropic.claude.tool.mcp.ToolsFrame", kVar, 2);
    ...
    public final KSerializer[] childSerializers() {
        return new KSerializer[]{p3b.a, ToolsFrame.$childSerializers[1].getValue()};
    }
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        kw9[] kw9VarArr = ToolsFrame.$childSerializers;
        boolean z = true;
        int i = 0;
        ...
        return new ToolsFrame(i, strM1035unboximpl, list, null, null);
    }
    ...
    public final void serialize(Encoder encoder, Object obj) {
        ToolsFrame toolsFrame = (ToolsFrame) obj;
        encoder.getClass();
        toolsFrame.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        vd4 vd4VarC = encoder.c(serialDescriptor);
        ToolsFrame.write$Self$tool(toolsFrame, vd4VarC, serialDescriptor);
