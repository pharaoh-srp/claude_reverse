...
public final class MTOverLeftArrow extends MTMathAtom {
    ...
    public MTOverLeftArrow copyDeep() throws MathDisplayException {
    ...
    @Override // com.agog.mathdisplay.parse.MTMathAtom
    public MTOverLeftArrow finalized() throws MathDisplayException {
        MTOverLeftArrow mTOverLeftArrowCopyDeep = copyDeep();
        finalized(mTOverLeftArrowCopyDeep);
        MTMathList mTMathList = mTOverLeftArrowCopyDeep.innerList;
        mTOverLeftArrowCopyDeep.innerList = mTMathList != null ? mTMathList.finalized() : null;
        return mTOverLeftArrowCopyDeep;
    }
    ...
    public String toLatexString() {
        MTMathList mTMathList = this.innerList;
        return ij0.j("\\overleftarrow{", mTMathList != null ? MTMathListBuilder.INSTANCE.toLatexString(mTMathList) : "", "}");
    }
}
