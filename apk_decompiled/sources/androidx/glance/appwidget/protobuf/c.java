...
public final class c extends r34 {
    ...
    public final String A() throws InvalidProtocolBufferException {
        ...
        if (iK > 0) {
            ...
            int i2 = this.g;
            if (iK <= i - i2) {
                String str = new String(bArr, i2, iK, r89.a);
                this.g += iK;
                return str;
            }
        }
        ...
        if (iK > this.e) {
            return new String(F(iK), r89.a);
        }
        O(iK);
        String str2 = new String(bArr, this.g, iK, r89.a);
        this.g += iK;
        return str2;
    }
    ...
    @Override // defpackage.r34
    public final e22 n() throws IOException {
        int iK = K();
        int i = this.e;
        int i2 = this.g;
        int i3 = i - i2;
        ...
        byte[] bArrG = G(iK);
        if (bArrG != null) {
            return e22.e(bArrG, 0, bArrG.length);
        }
        int i4 = this.g;
        int i5 = this.e;
        int length = i5 - i4;
