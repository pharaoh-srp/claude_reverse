...
public class AlertDialogLayout extends i6a {
        ...
        if (mode2 != 1073741824) {
            ...
            while (i9 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) h6aVar).width == -1) {
                        int i10 = ((LinearLayout.LayoutParams) h6aVar).height;
                        ((LinearLayout.LayoutParams) h6aVar).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i8, 0);
                        ((LinearLayout.LayoutParams) h6aVar).height = i10;
                    }
                }
                i9++;
