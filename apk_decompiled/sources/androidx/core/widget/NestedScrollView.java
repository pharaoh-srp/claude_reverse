...
public class NestedScrollView extends FrameLayout implements l0c, ScrollingView {
    public static final float j0 = (float) (Math.log(0.78d) / Math.log(0.9d));
    public static final g0c k0 = new g0c();
    public static final int[] l0 = {R.attr.fillViewport};
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.a0 = new int[2];
        this.b0 = new int[2];
        this.i0 = new m46(getContext(), new ro6(15, this));
        int i2 = Build.VERSION.SDK_INT;
        this.I = i2 >= 31 ? xi6.a(context, attributeSet) : new EdgeEffect(context);
        this.J = i2 >= 31 ? xi6.a(context, attributeSet) : new EdgeEffect(context);
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, l0, i, 0);
    ...
    private c9f getScrollFeedbackProvider() {
        if (this.K == null) {
            this.K = new c9f(this);
        }
        return this.K;
    ...
    public final void addView(View view) {
        if (getChildCount() <= 0) {
            ...
            sz6.j("ScrollView can host only one direct child");
        }
    }
    ...
    */
    ...
    public final boolean dispatchNestedFling(float f, float f2, boolean z) {
        ...
        cp1 cp1Var = this.g0;
        if (cp1Var.a && (viewParentC = cp1Var.c(0)) != null) {
            try {
                return viewParentC.onNestedFling((NestedScrollView) cp1Var.d, f, f2, z);
    ...
    public final boolean dispatchNestedPreFling(float f, float f2) {
        ...
        if (cp1Var.a && (viewParentC = cp1Var.c(0)) != null) {
            try {
                return viewParentC.onNestedPreFling((NestedScrollView) cp1Var.d, f, f2);
            } catch (AbstractMethodError e) {
    ...
    public final boolean dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr) {
        return this.g0.b(i, i2, i3, i4, iArr, 0, null);
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.rotate(180.0f, width2, MTTypesetterKt.kLineSkipLimitMultiplier);
    ...
    public float getVerticalScrollFactorCompat() {
        if (this.h0 == MTTypesetterKt.kLineSkipLimitMultiplier) {
            TypedValue typedValue = new TypedValue();
            Context context = getContext();
            if (!context.getTheme().resolveAttribute(R.attr.listPreferredItemHeight, typedValue, true)) {
                sz6.j("Expected theme to define listPreferredItemHeight.");
                return MTTypesetterKt.kLineSkipLimitMultiplier;
            }
    ...
    public final boolean i(int i, int i2, int i3, int[] iArr, int[] iArr2) {
        ...
        int i5;
        cp1 cp1Var = this.g0;
        NestedScrollView nestedScrollView = (NestedScrollView) cp1Var.d;
        if (!cp1Var.a || (viewParentC = cp1Var.c(i3)) == null) {
            return false;
        }
        if (i == 0 && i2 == 0) {
            if (iArr2 == null) {
        ...
        iArr[0] = 0;
        iArr[1] = 0;
        NestedScrollView nestedScrollView2 = (NestedScrollView) cp1Var.d;
        if (viewParentC instanceof k0c) {
            ((k0c) viewParentC).h(i, i2, iArr, i3);
        } else if (i3 == 0) {
            try {
    ...
    */
    ...
    public final void k(int i) {
        if (getChildCount() > 0) {
            ...
            if (Build.VERSION.SDK_INT >= 35) {
                h0c.a(this, Math.abs(this.H.getCurrVelocity()));
            }
        }
    }
    ...
    public final void o(int i, int i2, int[] iArr) {
        ...
        this.g0.b(0, scrollY2, 0, i - scrollY2, null, i2, iArr);
    }
    ...
    */
    ...
    public final boolean onNestedFling(View view, float f, float f2, boolean z) {
        ...
        dispatchNestedFling(MTTypesetterKt.kLineSkipLimitMultiplier, f2, true);
        k((int) f2);
        return true;
    }
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        if (!(parcelable instanceof j0c)) {
            super.onRestoreInstanceState(parcelable);
            return;
        }
        j0c j0cVar = (j0c) parcelable;
        super.onRestoreInstanceState(j0cVar.getSuperState());
        this.e0 = j0cVar;
        requestLayout();
    }
    ...
    public final Parcelable onSaveInstanceState() {
        j0c j0cVar = new j0c(super.onSaveInstanceState());
        j0cVar.E = getScrollY();
        return j0cVar;
    }
    ...
    */
    ...
    public void setOnScrollChangeListener(i0c i0cVar) {
    }
    ...
    */
    ...
    public final boolean u(EdgeEffect edgeEffect, int i) {
        ...
        float fG = yuj.g(edgeEffect) * getHeight();
    ...
    public final boolean w(int i, int i2) {
        ...
        cp1 cp1Var = this.g0;
        View view = (NestedScrollView) cp1Var.d;
        if (cp1Var.c(i2) != null) {
            return true;
        }
        if (cp1Var.a) {
            ...
            for (ViewParent parent = view.getParent(); parent != null; parent = parent.getParent()) {
                boolean z = parent instanceof k0c;
                if (z) {
                    zOnStartNestedScroll = ((k0c) parent).d(view2, view, i, i2);
                } else if (i2 == 0) {
                    try {
    ...
    public final boolean x(MotionEvent motionEvent) {
        boolean z;
        EdgeEffect edgeEffect = this.I;
        if (yuj.g(edgeEffect) != MTTypesetterKt.kLineSkipLimitMultiplier) {
            yuj.h(edgeEffect, MTTypesetterKt.kLineSkipLimitMultiplier, motionEvent.getX() / getWidth());
            z = true;
        } else {
            z = false;
        }
        EdgeEffect edgeEffect2 = this.J;
        if (yuj.g(edgeEffect2) == MTTypesetterKt.kLineSkipLimitMultiplier) {
            return z;
        }
        yuj.h(edgeEffect2, MTTypesetterKt.kLineSkipLimitMultiplier, 1.0f - (motionEvent.getX() / getWidth()));
        return true;
    }

    public final void y(int i) {
        cp1 cp1Var = this.g0;
        ViewParent viewParentC = cp1Var.c(i);
        if (viewParentC != null) {
            NestedScrollView nestedScrollView = (NestedScrollView) cp1Var.d;
            if (viewParentC instanceof k0c) {
                ((k0c) viewParentC).f(nestedScrollView, i);
            } else if (i == 0) {
                try {
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, com.anthropic.claude.R.attr.nestedScrollViewStyle);
    }
