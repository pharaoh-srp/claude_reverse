...
public final class fwi {
    ...
    public fwi(int i, String str, String str2, String str3, String str4, String str5, List list, String str6, Number number, Boolean bool, Number number2, Number number3, Number number4, Boolean bool2) {
        this.a = i;
        this.b = str;
        this.c = str2;
        this.d = str3;
    ...
    public final boolean equals(Object obj) {
        ...
        fwi fwiVar = (fwi) obj;
        return this.a == fwiVar.a && x44.r(this.b, fwiVar.b) && x44.r(this.c, fwiVar.c) && x44.r(this.d, fwiVar.d) && x44.r(this.e, fwiVar.e) && x44.r(this.f, fwiVar.f) && x44.r(this.g, fwiVar.g) && x44.r(this.h, fwiVar.h) && x44.r(this.i, fwiVar.i) && x44.r(this.j, fwiVar.j) && x44.r(this.k, fwiVar.k) && x44.r(this.l, fwiVar.l) && x44.r(this.m, fwiVar.m) && x44.r(this.n, fwiVar.n);
    }
