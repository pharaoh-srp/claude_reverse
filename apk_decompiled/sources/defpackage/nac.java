...
public final class nac extends sk8 {
    public static final nac j;

    static {
        Map mapSingletonMap = Collections.singletonMap(ls.E, new ws1(qac.z0, 3));
        mapSingletonMap.getClass();
        j = new nac("NutritionProteinRecord", R.string.health_data_type_nutrition_protein, jce.a.b(qac.class), z7e.F, "g", mapSingletonMap, false);
    }
