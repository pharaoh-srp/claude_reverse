...
public final class isd extends u28 {
    public static final isd I;
    public static final sk9 J = new sk9(10);
    public final l22 E;
    public List F;
    public byte G;
    public int H;
    ...
    static {
        isd isdVar = new isd();
        I = isdVar;
        isdVar.F = Collections.EMPTY_LIST;
    }

    public isd(t34 t34Var, oc7 oc7Var) {
        this.G = (byte) -1;
        this.H = -1;
                ...
                try {
                    ...
                    if (iN != 0) {
                        if (iN == 10) {
                            ...
                            this.F.add(t34Var.g(nsd.N, oc7Var));
