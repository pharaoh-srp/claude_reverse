...
public final /* synthetic */ class ei3 implements w28 {
    ...
    static {
        ei3 ei3Var = new ei3();
        a = ei3Var;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("claudeai.message.response_complete", ei3Var, 23);
        ...
        pluginGeneratedSerialDescriptor.j("stop_reason", false);
    ...
    public final KSerializer[] childSerializers() {
        kw9[] kw9VarArr = ClaudeAiMessageEvents$MessageResponseComplete.$childSerializers;
        xka xkaVar = xka.a;
        srg srgVar = srg.a;
        e79 e79Var = e79.a;
        zt1 zt1Var = zt1.a;
        return new KSerializer[]{xkaVar, xkaVar, srgVar, srgVar, srgVar, d4c.S(srgVar), e79Var, e79Var, zt1Var, zt1Var, zt1Var, zt1Var, d4c.S(srgVar), kw9VarArr[13].getValue(), e79Var, e79Var, e79Var, srgVar, e79Var, e79Var, xkaVar, zt1Var, d4c.S(srgVar)};
    }
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        kw9[] kw9VarArr2 = ClaudeAiMessageEvents$MessageResponseComplete.$childSerializers;
        long j = 0;
        long j2 = 0;
        long j3 = 0;
        String str = null;
        ...
        while (z) {
            ...
            switch (iX) {
                ...
                case 11:
                    kw9VarArr = kw9VarArr2;
                    zU4 = ud4VarC.u(serialDescriptor, 11);
                ...
                case g.MAX_FIELD_NUMBER /* 17 */:
                    kw9VarArr = kw9VarArr2;
                    strV4 = ud4VarC.v(serialDescriptor, 17);
                    i = 131072;
                    break;
                case g.AVG_FIELD_NUMBER /* 18 */:
                    kw9VarArr = kw9VarArr2;
                    iR6 = ud4VarC.r(serialDescriptor, 18);
                    i = 262144;
                    break;
                case g.START_ZONE_OFFSET_SECONDS_FIELD_NUMBER /* 19 */:
                    kw9VarArr = kw9VarArr2;
                    iR7 = ud4VarC.r(serialDescriptor, 19);
                    i = 524288;
                    break;
                case g.END_ZONE_OFFSET_SECONDS_FIELD_NUMBER /* 20 */:
                    kw9VarArr = kw9VarArr2;
                    j3 = ud4VarC.j(serialDescriptor, 20);
                    i = FreeTypeConstants.FT_LOAD_COLOR;
                    break;
                case 21:
                    kw9VarArr = kw9VarArr2;
                    zU5 = ud4VarC.u(serialDescriptor, 21);
                    i = FreeTypeConstants.FT_LOAD_COMPUTE_METRICS;
                    break;
                case g.SUB_TYPE_DATA_LISTS_FIELD_NUMBER /* 22 */:
                    kw9VarArr = kw9VarArr2;
                    str = (String) ud4VarC.m(serialDescriptor, 22, srg.a, str);
                    i = 4194304;
                    break;
                default:
                    sz6.e(iX);
        ...
        return new ClaudeAiMessageEvents$MessageResponseComplete(i2, j, j2, strV, strV2, strV3, str2, iR, iR2, zU, zU2, zU3, zU4, str3, claudeAiMessageEvents$ResearchMode, iR3, iR4, iR5, strV4, iR6, iR7, j3, zU5, str, (vnf) null);
    }
    ...
    public final void serialize(Encoder encoder, Object obj) {
        ClaudeAiMessageEvents$MessageResponseComplete claudeAiMessageEvents$MessageResponseComplete = (ClaudeAiMessageEvents$MessageResponseComplete) obj;
        encoder.getClass();
        claudeAiMessageEvents$MessageResponseComplete.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        vd4 vd4VarC = encoder.c(serialDescriptor);
        ClaudeAiMessageEvents$MessageResponseComplete.write$Self$analytics(claudeAiMessageEvents$MessageResponseComplete, vd4VarC, serialDescriptor);
