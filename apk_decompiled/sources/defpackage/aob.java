...
public final /* synthetic */ class aob implements w28 {
    ...
    static {
        aob aobVar = new aob();
        a = aobVar;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.anthropic.claude.conway.protocol.ModelInfo", aobVar, 2);
    ...
    public final KSerializer[] childSerializers() {
        return new KSerializer[]{d4c.S(vnb.a), ModelInfo.$childSerializers[1].getValue()};
    }
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        kw9[] kw9VarArr = ModelInfo.$childSerializers;
        boolean z = true;
        int i = 0;
        ...
        return new ModelInfo(i, strM1064unboximpl, list, null, null);
    }
    ...
    public final void serialize(Encoder encoder, Object obj) {
        ...
        ModelInfo.write$Self$conway(modelInfo, vd4VarC, serialDescriptor);
