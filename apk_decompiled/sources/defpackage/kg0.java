...
public class kg0 extends CheckBox implements mrh {
    public final mg0 E;
    public final ig0 F;
    public final fi0 G;
    public fh0 H;
    ...
    public kg0(Context context, AttributeSet attributeSet) {
        ...
        this.E = mg0Var;
        mg0Var.c(attributeSet, R.attr.checkboxStyle);
        ig0 ig0Var = new ig0(this);
        this.F = ig0Var;
        ig0Var.l(attributeSet, R.attr.checkboxStyle);
        fi0 fi0Var = new fi0(this);
        this.G = fi0Var;
        fi0Var.f(attributeSet, R.attr.checkboxStyle);
