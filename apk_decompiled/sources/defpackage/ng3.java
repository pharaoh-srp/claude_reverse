...
public final /* synthetic */ class ng3 implements w28 {
    ...
    static {
        ng3 ng3Var = new ng3();
        a = ng3Var;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.anthropic.claude.api.chat.citation.CitationSource", ng3Var, 7);
        ...
        pluginGeneratedSerialDescriptor.j("content_body", true);
        descriptor = pluginGeneratedSerialDescriptor;
    }

    @Override // defpackage.w28
    public final KSerializer[] childSerializers() {
        kw9[] kw9VarArr = CitationSource.$childSerializers;
        srg srgVar = srg.a;
        return new KSerializer[]{d4c.S(srgVar), d4c.S(srgVar), d4c.S((KSerializer) kw9VarArr[2].getValue()), d4c.S(srgVar), d4c.S(srgVar), d4c.S(srgVar), d4c.S(srgVar)};
    }
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        return new CitationSource(i, str, str2, list, str3, str4, str5, str6, (vnf) null);
    }
    ...
    public final void serialize(Encoder encoder, Object obj) {
        ...
        CitationSource.write$Self$api(citationSource, vd4VarC, serialDescriptor);
