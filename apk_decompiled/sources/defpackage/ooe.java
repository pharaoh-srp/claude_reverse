...
public final class ooe {
    ...
    public ooe(int i, String str, String str2, String str3, String str4, String str5, List list, String str6, Number number, Boolean bool, Number number2, Number number3, Number number4, Boolean bool2) {
        this.a = i;
        this.b = str;
        this.c = str2;
        this.d = str3;
    ...
    public final boolean equals(Object obj) {
        ...
        ooe ooeVar = (ooe) obj;
        return this.a == ooeVar.a && x44.r(this.b, ooeVar.b) && x44.r(this.c, ooeVar.c) && x44.r(this.d, ooeVar.d) && x44.r(this.e, ooeVar.e) && x44.r(this.f, ooeVar.f) && x44.r(this.g, ooeVar.g) && x44.r(this.h, ooeVar.h) && x44.r(this.i, ooeVar.i) && x44.r(this.j, ooeVar.j) && x44.r(this.k, ooeVar.k) && x44.r(this.l, ooeVar.l) && x44.r(this.m, ooeVar.m) && x44.r(this.n, ooeVar.n);
    }
