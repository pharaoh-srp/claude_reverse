...
public final class jac extends sk8 {
    public static final jac j;

    static {
        Map mapSingletonMap = Collections.singletonMap(ls.E, new ws1(qac.G0, 3));
        mapSingletonMap.getClass();
        j = new jac("NutritionCarbsRecord", R.string.health_data_type_nutrition_carbs, jce.a.b(qac.class), z7e.F, "g", mapSingletonMap, false);
    }
