...
public final class qg implements lf {
    public static final ig e = new ig(1);
    public static final ig f = new ig(2);
    public final byte[] a;
    public final byte[] b;
    public final SecretKeySpec c;
    public final int d;

    public qg(byte[] bArr, int i) throws GeneralSecurityException {
        if (!gid.a(1)) {
            rl7.j("Can not use AES-EAX in FIPS-mode.");
            throw null;
        }
        if (i != 12 && i != 16) {
            sz6.p("IV size should be either 12 or 16 bytes");
            throw null;
        }
        this.d = i;
        rqi.a(bArr.length);
