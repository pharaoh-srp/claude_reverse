...
public final class oi0 {
    ...
    public final void a() {
        if (f()) {
            if (this.b) {
                ...
                int measuredWidth = this.k.b(this.i) ? FreeTypeConstants.FT_LOAD_COLOR : (this.i.getMeasuredWidth() - this.i.getTotalPaddingLeft()) - this.i.getTotalPaddingRight();
    ...
    public final int c(RectF rectF) {
        ...
        if (length == 0) {
            sz6.j("No available text sizes to choose from.");
            return 0;
        }
        int i = length - 1;
        int i2 = 0;
        ...
        while (true) {
            ...
            StaticLayout staticLayoutA = ki0.a(charSequence, (Layout.Alignment) e(textView, Layout.Alignment.ALIGN_NORMAL, "getLayoutAlignment"), Math.round(rectF.right), maxLines, this.i, this.h, this.k);
    ...
    public final void k(float f, float f2, float f3) {
        ...
        if (f2 <= f) {
            mr9.j("Maximum auto-size text size (", f2, "px) is less or equal to minimum auto-size text size (", f, "px)");
            return;
        }
