...
public final /* synthetic */ class iha implements w28 {
    ...
    static {
        iha ihaVar = new iha();
        a = ihaVar;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("mobile.login.email.code_verification_error", ihaVar, 4);
    ...
    public final KSerializer[] childSerializers() {
        kw9[] kw9VarArr = LoginEvents$EmailLoginCodeVerificationError.$childSerializers;
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        return new LoginEvents$EmailLoginCodeVerificationError(i, num, str, str2, loginEvents$LoginClientErrorKind, (vnf) null);
    }
    ...
    public final void serialize(Encoder encoder, Object obj) {
        LoginEvents$EmailLoginCodeVerificationError loginEvents$EmailLoginCodeVerificationError = (LoginEvents$EmailLoginCodeVerificationError) obj;
        encoder.getClass();
        loginEvents$EmailLoginCodeVerificationError.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        vd4 vd4VarC = encoder.c(serialDescriptor);
        LoginEvents$EmailLoginCodeVerificationError.write$Self$analytics(loginEvents$EmailLoginCodeVerificationError, vd4VarC, serialDescriptor);
