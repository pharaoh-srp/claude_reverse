...
public final /* synthetic */ class e6h implements w28 {
    public static final e6h a;
    private static final SerialDescriptor descriptor;

    static {
        e6h e6hVar = new e6h();
        a = e6hVar;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.anthropic.claude.tool.model.TaskListOutputTasksItem", e6hVar, 10);
    ...
    public final KSerializer[] childSerializers() {
        kw9[] kw9VarArr = TaskListOutputTasksItem.$childSerializers;
        srg srgVar = srg.a;
        ay6 ay6Var = ay6.a;
        return new KSerializer[]{srgVar, ay6Var, ay6Var, d4c.S(srgVar), h6h.d, d4c.S(srgVar), kw9VarArr[6].getValue(), srgVar, ay6Var, srgVar};
    }
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        String str = null;
        TaskListOutputTasksItemStatus taskListOutputTasksItemStatus = null;
        String str2 = null;
        List list = null;
        String strV2 = null;
        String strV3 = null;
        ...
        while (z) {
            ...
            switch (iX) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    taskListOutputTasksItemStatus = (TaskListOutputTasksItemStatus) ud4VarC.l(serialDescriptor, 4, h6h.d, taskListOutputTasksItemStatus);
                    i |= 16;
                    break;
                case 5:
        ...
        return new TaskListOutputTasksItem(i, strV, offsetDateTime2, offsetDateTime3, str, taskListOutputTasksItemStatus, str2, list, strV2, offsetDateTime, strV3, (vnf) null);
    }
    ...
    public final void serialize(Encoder encoder, Object obj) {
        TaskListOutputTasksItem taskListOutputTasksItem = (TaskListOutputTasksItem) obj;
        encoder.getClass();
        taskListOutputTasksItem.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        vd4 vd4VarC = encoder.c(serialDescriptor);
        TaskListOutputTasksItem.write$Self$Claude_tool_model(taskListOutputTasksItem, vd4VarC, serialDescriptor);
