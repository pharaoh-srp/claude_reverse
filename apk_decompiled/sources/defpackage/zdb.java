...
public class zdb extends k5 implements Menu {
    public final vcb c;

    public zdb(Context context, vcb vcbVar) {
        super(context);
        if (vcbVar != null) {
            this.c = vcbVar;
        } else {
    ...
    public final void removeGroup(int i) {
        if (((w6g) this.b) != null) {
            ...
            while (true) {
                ...
                if (((yyg) w6gVar.f(i2)).getGroupId() == i) {
                    ((w6g) this.b).g(i2);
                    i2--;
                }
                i2++;
    ...
    public final void removeItem(int i) {
        if (((w6g) this.b) != null) {
            ...
            while (true) {
                ...
                if (((yyg) w6gVar.f(i2)).getItemId() == i) {
                    ((w6g) this.b).g(i2);
                    break;
                }
                i2++;
