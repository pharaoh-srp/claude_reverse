...
public final class lac extends sk8 {
    public static final lac j;

    static {
        Map mapSingletonMap = Collections.singletonMap(ls.E, new ws1(qac.f0, 2));
        mapSingletonMap.getClass();
        j = new lac("NutritionEnergyRecord", R.string.health_data_type_nutrition_energy, jce.a.b(qac.class), z7e.F, "kcal", mapSingletonMap, false);
    }
    ...
    public final List b(y7e y7eVar) {
        ...
        yn6 yn6Var = qacVar.i;
        if (yn6Var == null || (strValueOf = String.valueOf(yn6Var.b())) == null) {
            strValueOf = TaskSessionEvent.REPLAY_FROM_START;
        }
        return x44.W(new b9e(offsetDateTime, offsetDateTimeR, strValueOf, "kcal"));
    }
}
