...
public final /* synthetic */ class ygd implements w28 {
    ...
    static {
        ygd ygdVar = new ygd();
        a = ygdVar;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("mobile.iap.pro.store_view.record_purchase.success", ygdVar, 8);
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        return new ProUpsellEvents$StoreViewRecordPurchaseSuccess(i, str, str2, str3, str4, str5, str6, str7, str8, (vnf) null);
    }
    ...
    public final void serialize(Encoder encoder, Object obj) {
        ProUpsellEvents$StoreViewRecordPurchaseSuccess proUpsellEvents$StoreViewRecordPurchaseSuccess = (ProUpsellEvents$StoreViewRecordPurchaseSuccess) obj;
        encoder.getClass();
        proUpsellEvents$StoreViewRecordPurchaseSuccess.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        vd4 vd4VarC = encoder.c(serialDescriptor);
        ProUpsellEvents$StoreViewRecordPurchaseSuccess.write$Self$analytics(proUpsellEvents$StoreViewRecordPurchaseSuccess, vd4VarC, serialDescriptor);
