...
public final /* synthetic */ class eha implements w28 {
    ...
    static {
        eha ehaVar = new eha();
        a = ehaVar;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("mobile.login.email.code_send_error", ehaVar, 4);
    ...
    public final KSerializer[] childSerializers() {
        kw9[] kw9VarArr = LoginEvents$EmailLoginCodeSendError.$childSerializers;
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        return new LoginEvents$EmailLoginCodeSendError(i, num, str, str2, loginEvents$LoginClientErrorKind, (vnf) null);
    }
    ...
    public final void serialize(Encoder encoder, Object obj) {
        LoginEvents$EmailLoginCodeSendError loginEvents$EmailLoginCodeSendError = (LoginEvents$EmailLoginCodeSendError) obj;
        encoder.getClass();
        loginEvents$EmailLoginCodeSendError.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        vd4 vd4VarC = encoder.c(serialDescriptor);
        LoginEvents$EmailLoginCodeSendError.write$Self$analytics(loginEvents$EmailLoginCodeSendError, vd4VarC, serialDescriptor);
