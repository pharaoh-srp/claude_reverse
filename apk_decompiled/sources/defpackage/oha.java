...
public final /* synthetic */ class oha implements w28 {
    ...
    static {
        oha ohaVar = new oha();
        a = ohaVar;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("mobile.login.email.magic_link_send_error", ohaVar, 4);
    ...
    public final KSerializer[] childSerializers() {
        kw9[] kw9VarArr = LoginEvents$EmailLoginMagicLinkSendError.$childSerializers;
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        return new LoginEvents$EmailLoginMagicLinkSendError(i, num, str, str2, loginEvents$LoginClientErrorKind, (vnf) null);
    }
    ...
    public final void serialize(Encoder encoder, Object obj) {
        LoginEvents$EmailLoginMagicLinkSendError loginEvents$EmailLoginMagicLinkSendError = (LoginEvents$EmailLoginMagicLinkSendError) obj;
        encoder.getClass();
        loginEvents$EmailLoginMagicLinkSendError.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        vd4 vd4VarC = encoder.c(serialDescriptor);
        LoginEvents$EmailLoginMagicLinkSendError.write$Self$analytics(loginEvents$EmailLoginMagicLinkSendError, vd4VarC, serialDescriptor);
