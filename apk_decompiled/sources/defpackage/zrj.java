...
public final class zrj implements uac {
    public static final Charset f = Charset.forName("UTF-8");
    public static final mh7 g = new mh7("key", ebh.t(fsh.r(orj.class, new qqj(1))));
    public static final mh7 h = new mh7(ExperienceToggle.DEFAULT_PARAM_KEY, ebh.t(fsh.r(orj.class, new qqj(2))));
    public static final urj i = urj.b;
    public OutputStream a;
    public final HashMap b;
    public final HashMap c;
    public final tac d;
    public final avd e = new avd(this, 1);

    public zrj(ByteArrayOutputStream byteArrayOutputStream, HashMap map, HashMap map2, tac tacVar) {
    ...
    public static int g(mh7 mh7Var) {
        orj orjVar = (orj) mh7Var.a(orj.class);
        if (orjVar != null) {
            return orjVar.zza();
        }
    ...
    public final void c(mh7 mh7Var, int i2, boolean z) {
        ...
        int iOrdinal = orjVar.zzb().ordinal();
        if (iOrdinal == 0) {
            i(orjVar.zza() << 3);
            i(i2);
        } else if (iOrdinal == 1) {
