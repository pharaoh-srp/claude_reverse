...
public final /* synthetic */ class hl7 implements w28 {
    public static final hl7 a;
    private static final SerialDescriptor descriptor;

    static {
        hl7 hl7Var = new hl7();
        a = hl7Var;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.anthropic.claude.api.sync.FinishAuthRequest", hl7Var, 4);
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        return new FinishAuthRequest(i, str, str2, str3, str4, (vnf) null);
    }
    ...
    public final void serialize(Encoder encoder, Object obj) {
        FinishAuthRequest finishAuthRequest = (FinishAuthRequest) obj;
        encoder.getClass();
        finishAuthRequest.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        vd4 vd4VarC = encoder.c(serialDescriptor);
        FinishAuthRequest.write$Self$api(finishAuthRequest, vd4VarC, serialDescriptor);
