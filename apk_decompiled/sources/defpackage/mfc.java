...
public final /* synthetic */ class mfc implements w28 {
    ...
    static {
        mfc mfcVar = new mfc();
        a = mfcVar;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("onboarding.phone_verification.country_code_dialog.finished", mfcVar, 1);
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        while (true) {
            ...
            if (!z) {
                ...
                return new OnboardingEvents$PhoneVerificationCountryCodeDialogFinished(i, iR, vnfVar);
            }
    ...
    public final void serialize(Encoder encoder, Object obj) {
        ...
        encoder.getClass();
        onboardingEvents$PhoneVerificationCountryCodeDialogFinished.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        vd4 vd4VarC = encoder.c(serialDescriptor);
        vd4VarC.l(0, onboardingEvents$PhoneVerificationCountryCodeDialogFinished.country_code, serialDescriptor);
