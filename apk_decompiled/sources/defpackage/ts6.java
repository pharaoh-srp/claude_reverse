...
public final class ts6 {
    ...
    public /* synthetic */ ts6(int i, String str, String str2, String str3, String str4, List list, String str5, Number number, Boolean bool, Number number2, Integer num, Number number3, Boolean bool2, int i2) {
        this(i, str, str2, str3, str4, (String) null, (i2 & 64) != 0 ? null : list, (i2 & FreeTypeConstants.FT_LOAD_PEDANTIC) != 0 ? null : str5, (i2 & FreeTypeConstants.FT_FSTYPE_NO_SUBSETTING) != 0 ? null : number, (i2 & 512) != 0 ? null : bool, (i2 & FreeTypeConstants.FT_LOAD_NO_RECURSE) != 0 ? null : number2, num, number3, bool2);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        ts6 ts6Var = (ts6) obj;
        return this.a == ts6Var.a && x44.r(this.b, ts6Var.b) && x44.r(this.c, ts6Var.c) && x44.r(this.d, ts6Var.d) && x44.r(this.e, ts6Var.e) && x44.r(this.f, ts6Var.f) && x44.r(this.g, ts6Var.g) && x44.r(this.h, ts6Var.h) && x44.r(this.i, ts6Var.i) && x44.r(this.j, ts6Var.j) && x44.r(this.k, ts6Var.k) && x44.r(this.l, ts6Var.l) && x44.r(this.m, ts6Var.m) && x44.r(this.n, ts6Var.n);
    }
    ...
    public ts6(int i, String str, String str2, String str3, String str4, String str5, List list, String str6, Number number, Boolean bool, Number number2, Number number3, Number number4, Boolean bool2) {
        this.a = i;
        this.b = str;
        this.c = str2;
        this.d = str3;
