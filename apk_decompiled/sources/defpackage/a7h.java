...
public final /* synthetic */ class a7h implements w28 {
    ...
    static {
        a7h a7hVar = new a7h();
        a = a7hVar;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.anthropic.claude.tool.model.TaskProposeOutput", a7hVar, 10);
    ...
    public final KSerializer[] childSerializers() {
        kw9[] kw9VarArr = TaskProposeOutput.$childSerializers;
        srg srgVar = srg.a;
        ay6 ay6Var = ay6.a;
        return new KSerializer[]{srgVar, ay6Var, ay6Var, d4c.S(srgVar), d7h.d, d4c.S(srgVar), kw9VarArr[6].getValue(), srgVar, ay6Var, srgVar};
    }
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        String str = null;
        TaskProposeOutputStatus taskProposeOutputStatus = null;
        String str2 = null;
        List list = null;
        String strV2 = null;
        String strV3 = null;
        ...
        while (z) {
            ...
            switch (iX) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    taskProposeOutputStatus = (TaskProposeOutputStatus) ud4VarC.l(serialDescriptor, 4, d7h.d, taskProposeOutputStatus);
                    i |= 16;
                    break;
                case 5:
        ...
        return new TaskProposeOutput(i, strV, offsetDateTime2, offsetDateTime3, str, taskProposeOutputStatus, str2, list, strV2, offsetDateTime, strV3, (vnf) null);
    }
    ...
    public final void serialize(Encoder encoder, Object obj) {
        TaskProposeOutput taskProposeOutput = (TaskProposeOutput) obj;
        encoder.getClass();
        taskProposeOutput.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        vd4 vd4VarC = encoder.c(serialDescriptor);
        TaskProposeOutput.write$Self$Claude_tool_model(taskProposeOutput, vd4VarC, serialDescriptor);
