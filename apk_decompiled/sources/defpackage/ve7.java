...
public final class ve7 implements Interpolator {
    ...
    public final float getInterpolation(float f) {
        ...
        float f4 = fArr[iMin];
        return sq6.k(fArr[iMin + 1], f4, f3, f4);
    }
}
