...
public final class tbh {
    ...
    public tbh(String str, String str2, String str3, Number number, Number number2, Boolean bool) {
        this.a = str;
        this.b = str2;
        this.c = str3;
        this.d = number;
    ...
    public final boolean equals(Object obj) {
        ...
        tbh tbhVar = (tbh) obj;
        return x44.r(this.a, tbhVar.a) && x44.r(this.b, tbhVar.b) && x44.r(this.c, tbhVar.c) && x44.r(this.d, tbhVar.d) && x44.r(this.e, tbhVar.e) && x44.r(this.f, tbhVar.f);
    }
