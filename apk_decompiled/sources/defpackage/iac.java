...
public final class iac extends sk8 {
    public static final iac j;

    static {
        Map mapSingletonMap = Collections.singletonMap(ls.E, new ws1(qac.d0, 3));
        mapSingletonMap.getClass();
        j = new iac("NutritionCaffeineRecord", R.string.health_data_type_nutrition_caffeine, jce.a.b(qac.class), z7e.F, "mg", mapSingletonMap, false);
    }
    ...
    public final List b(y7e y7eVar) {
        ...
        fva fvaVar = qacVar.g;
        if (fvaVar == null || (strValueOf = String.valueOf(fvaVar.a(eva.G))) == null) {
            strValueOf = TaskSessionEvent.REPLAY_FROM_START;
        }
        return x44.W(new b9e(offsetDateTime, offsetDateTimeR, strValueOf, "mg"));
    }
}
