...
public abstract /* synthetic */ class ah7 {
    public static final /* synthetic */ int[] a;

    static {
        int[] iArr = new int[MobileAppFeedbackEvents$FeedbackType.values().length];
        try {
            iArr[MobileAppFeedbackEvents$FeedbackType.GENERAL_FEEDBACK.ordinal()] = 1;
        } catch (NoSuchFieldError unused) {
        }
        try {
            iArr[MobileAppFeedbackEvents$FeedbackType.BUG_REPORT.ordinal()] = 2;
        } catch (NoSuchFieldError unused2) {
        }
        try {
            iArr[MobileAppFeedbackEvents$FeedbackType.FEATURE_REQUEST.ordinal()] = 3;
