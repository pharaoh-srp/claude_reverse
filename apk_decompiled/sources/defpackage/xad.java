...
public final class xad {
    ...
    public xad(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
        if (Build.VERSION.SDK_INT >= 29) {
            l5d.h(textPaint).setBreakStrategy(i).setHyphenationFrequency(i2).setTextDirection(textDirectionHeuristic).build();
        }
        this.a = textPaint;
    ...
    public final boolean equals(Object obj) {
        ...
        xad xadVar = (xad) obj;
        int i = xadVar.c;
        TextPaint textPaint = xadVar.a;
        if (this.c != i || this.d != xadVar.d) {
            return false;
        }
    ...
    public xad(PrecomputedText.Params params) {
